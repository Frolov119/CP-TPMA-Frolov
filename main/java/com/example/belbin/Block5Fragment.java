...
public class Block5Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_block5, container, false);
        Resources res = getResources();
        String[] statements = res.getStringArray(R.array.statements5);
